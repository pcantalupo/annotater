...
# 9/20/10 I just learned that Bio::DB::SoapEUtilities might be more
# robust/stable in the future.  I need to rewrite these subroutines to use
# the new NCBI SOAP service
